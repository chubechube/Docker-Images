#!/bin/sh
# 
# Welfinity Create Market for Farmadati Table TR001
# Author : Cristiano Ressi di Cervia , Welfinity
# date : 11/12/2017
# version : 1.0
#
# The aim of this job is to  create a table TR001 using Farmadati Soap Service
# 
# 
#Logging setup
...
#Process Data
echo "$LOG_DATE Create Market TR001"
