...
/opt/welfinity/talend/scripts/pharmacyload/LoadBelgianPharmacies.sh 94.23.179.228 27017 Pharmacies_list belgium  talendUser  ba+Req6@agu6 /var/log/welfinity/talend/pharmacyload/