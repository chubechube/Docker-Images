...
if [ $# != 13 ]; then
	...
	echo "Example : ./Aggregation_Italy.sh 94.23.179.228 27017 talendUser ba+Req6@agu6 Pharmacies_list Italy markets Product_Dictionaries_Italy /data/aggregate/Italy/toAggregate/ /data/aggregate/Italy/Aggregated/ filetoaggregate.csv aggregated.xls /var/log/welfinity/talend/WDM/"
	exit
fi
...
/opt/welfinity/talend/jobs/WDM/WDM_Import_Italian_Data_Using_Market/WDM_Import_Italian_Data_Using_Market/WDM_Import_Italian_Data_Using_Market_run.sh --context_param database_url=$1 --context_param database_port=$2 --context_param database_pharmacies=$5  --context_param collection=$6 --context_param user=$3 --context_param password=$4 --context_param logDirectory=$13 --context_param database_products=$7 --context_param database_farmadati=$8 --context_param sourceDirectory=$9 --context_param destDirectory=$10 --context_param sourcefile=$11 --context_param destFile=$12