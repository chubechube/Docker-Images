...
case $OS in
  ...
  'Darwin') 
    OS='Mac'
	/usr/local/bin/rancher-compose --url http://94.23.179.226:8080 --access-key B9A804A459E2E4B4740A --secret-key 8bNu9VZr4zepeVGSDFLR1aRs94wUSNXz74pQ8Hsx -p $1 up -d
    ;;
  *) ;;
esac
