#!/bin/sh
# 
# Welfinity Create Market Support Tables from MongoDB 
# Author : Cristiano Ressi di Cervia , Welfinity
# date : 12/04/2018
# version : 1.0
#
# The aim of this job is to  create the market  support tables from a MongodbTable for a specific market 
# 
# 
#Logging setup
...
FILENAME="$NOW-Create_Market_Support_Tables_From_Mongodb.log"
...
if [ $# != 15 ]; then
	...
	echo "Example : ./Create_Market_Support_Tables_From_MongoDB.sh 94.23.179.229 27017  markets italianmarkets talendUser ba+Req6@agu6   Product_Dictionaries_Italy TR017 TestTabs markets FDI_T139 /var/log/welfinity/talend/WIM/ FDI_T139 1 1"
	exit
fi
...
echo "$LOG_DATE parameters : DATABASE_URL => $1 DATABASE_PORT => $2 DATABASE_MARKET => $3 COLLECTION_MARKET => $4 DB_USERNAME => $5 DB_PASSWORD => $6 DATABASE_SOURCE => $7 COLLECTION_SOURCE => $8 MARKET_NAME => $9 DATABASE_DESTINATION=>$10  QUERY_KEY=$11 LOGDIR => $12 UNIQUE_INDEX => $14 CREATE_INDEX = $15"

#Process Data
echo "$LOG_DATE Start Create Market Support Tables From MongoDB"
/opt/welfinity/talend/jobs/WIM/Create_Market_Support_Table_From_MongoDB/Create_Market_Support_Table_From_MongoDB/Create_Market_Support_Table_From_MongoDB_run.sh --context_param database_url=$1 --context_param database_port=$2 --context_param database_market=$3  --context_param collection_market=$4 --context_param db_user=$5 --context_param db_password=$6  --context_param database_source=$7  --context_param collection_source=$8 --context_param marketName=$9 --context_param database_destination=$10 --context_param querykey=$11	--context_param logDirectory=$12 --context_param indexKey=$13 --context_param uniqueIndes=$14 --context_param createIndex=$15
